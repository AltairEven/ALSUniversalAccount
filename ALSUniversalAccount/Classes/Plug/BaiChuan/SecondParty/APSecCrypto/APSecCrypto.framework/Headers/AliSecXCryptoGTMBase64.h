...
#define __BASE64_ENCODE(nsdata) [AliSecXCryptoGTMBase64 stringByEncodingData:nsdata]
#define __BASE64_DECODE(nsstring) [AliSecXCryptoGTMBase64 decodeString:nsstring]
#define __BASE64_URLSAFE_ENCODE(nsdata) [AliSecXCryptoGTMBase64 stringByWebSafeEncodingData:nsdata padded:NO]
#define __BASE64_URLSAFE_DECODE(nsstring) [AliSecXCryptoGTMBase64 webSafeDecodeString:nsstring]
