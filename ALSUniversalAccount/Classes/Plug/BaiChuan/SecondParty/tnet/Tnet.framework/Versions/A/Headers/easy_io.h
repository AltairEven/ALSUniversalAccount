...
extern int easy_slightssl_client_init(easy_connection_t *c);
extern int easy_slightssl_init(easy_io_t *eio);
extern int easy_slightssl_cleanup(easy_io_t *eio);
extern int easy_slightssl_connection_destroy(easy_connection_t *c);

//v2
extern int easy_slightssl_init_v2(easy_io_t *eio);
extern int easy_slightssl_cleanup_v2(easy_io_t *eio);
extern int easy_slightssl_connection_destroy_v2(easy_connection_t *c);
extern void easy_slightssl_client_handshake_cb_v2(struct ev_loop *loop, ev_io *w, int revents);
extern void easy_slightssl_client_handshake_v2(easy_connection_t *c);
#endif
...
#define easy_slightssl_set_pubkey_cb(eio, cb)        SLIGHT_SSL_CTX_set_pubkey_cb((eio)->ss_ctx, cb)
