...
//    :::..::::........:::......::........::..::::..::
//
//  Created by 亿刀 on 13-7-7.
//  Copyright (c) 2013年 亿刀. All rights reserved.
//


@protocol TBSecretMgrProtocol <NSObject>
 ...
 *
 *  @param envIndex 环境参数 （注意，0，1，2的顺序只是qz_11中存放appkey顺序的一个约定，可以自定义其顺序）
 */
...
/**
 *  返回当前使用的appkey，appkey来自qz_11加密文件
 *
 ...
 *  @param appkeyIndex 签名时需要使用的appsecret所对应的appkey在qz_11中的index，从0开始
 *
 ...
 *  @param appkeyIndex  解密encryptedKey时需要的appsecret所对应的appkey在qz_11中的index，从0开始
 *
